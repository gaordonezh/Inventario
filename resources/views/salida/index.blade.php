...
?>
    <div class="alert alert-light" role="alert"> Listado <h3>Salidas</h3> </div>
    <div class="row">
        <div class="col-lg-12">
            <div class="input-group">
                ...
                <!-- BUSCAR -->
                <form action="/salida" method="get" autocomplete="off" role="search" style="width:calc(100% - 45px)">
                    <div class="input-group">
                            ...
                            <tr>
                                ...
                                <td style="background:none">
                                    <div class="table-data-feature">
                                        <form action="{{ url('/salida/'.$dato->id) }}" method="post">
                                            {{ csrf_field() }}
                                            {{ method_field('DELETE') }}
        ...
        <div class="modal-dialog modal-lg" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="mediumModalLabel">REGISTRAR NUEVA SALIDA</h5>
                ...
                <div class="modal-body">
                    <div class="card">
                        <div class="card-body">
                            <form action="/salida" method="post" class="row" autocomplete="off" enctype="multipart/form-data">
                                {{ csrf_field() }}
                                <div class="col-lg-6">
