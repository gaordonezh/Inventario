            ...
            <div class="row">
                <div class="col-lg-12">
                    <div class="input-group">
                        ...
                        <!-- BUSCAR -->
                        <form action="/categoria" method="get" autocomplete="off" role="search" style="width:calc(100% - 45px)">
                            <div class="input-group">
                                    ...
                                    <tr>
                                        ...
                                        <td style="background:none">
                                            <div class="table-data-feature">
                                                <a href="/categoria/{{ $dato->id}}/edit" class="item" data-toggle="tooltip" data-placement="top" title="Edit"><i class="zmdi zmdi-edit"></i></a>
                                                <form action="{{ url('/categoria/'.$dato->id) }}" method="post">
                                                    {{ csrf_field() }}
                                                    {{ method_field('DELETE') }}
                                                ...
                                                <a href="/producto/{{ $dato->id}}" class="item" data-toggle="tooltip" data-placement="top" title="Ver mas"><i class="zmdi zmdi-more"></i></a>
                                            </div>
                                        </td>
                                    </tr>
                                @endforeach
